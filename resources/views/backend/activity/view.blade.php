    ...
    <div class="card">
      ...
      <div class="card-body">
         ...
         <div class="row  mt-2">
            ...
            <div class="col-md-6">
                <label class="form-label" for="formValidationName"><span class="mandatory"></span> Activity </label>
                <input type="text" class="form-control" value="{{$activity->activity}}" readonly />
                
            </div>
            {{--<div class="col-md-6">
                <label class="form-label" for="formValidationName"><span class="mandatory"></span> Client Group </label>
                <input type="text" class="form-control" value="{{$activity->client_group}}" readonly />
...
<div class="col-md-4">
                ...
                <label class="form-label" for="formValidationConfirmPass"><span class="mandatory"></span>Date</label>
                <div class="input-group input-group-merge">
                    <input class="form-control" type="text" value="{{$activity->date}}"  readonly />
             ...
             <div class="col-md-4">
                <div class="form-password-toggle">
                <label class="form-label" for="formValidationConfirmPass"><span class="mandatory"></span>Time</label>
                <div class="input-group input-group-merge">
                    <input class="form-control" type="text" value="{{$activity->time}}" readonly />
            ...
            <div class="col-md-4">
            <div class="form-password-toggle">
                <label class="form-label" for="formValidationConfirmPass"><span class="mandatory">*</span> Created By</label>
                <div class="input-group input-group-merge">
                    <input class="form-control" type="text" value="<?php $val=App\Models\User::where('id',$activity->created)->first(); echo $val->name; ?>" readonly />
