...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item">
          <a href="javascript:void(0);">Import Client Entity</a>
        </li>
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form id="formValidationExamples" class="row g-3" action="{{url('importentity')}}" method="POST" enctype="multipart/form-data">
             @csrf
...
<p class="font14 textLeft">
                    ...
                    {{__("2. Client Entity Name are unique. Although Client Entity Name is required.")}} <br/>
                    ...
                    <b><a href='{{url("")}}/excel/entity_import.xlsx'  target="_blank">{{__('Sample Excel File')}}</a></b>
                  </p>
         ...
         <div class="row  mt-2">
          ...
          <div class="col-md-12">
                ...
                <label class="form-label" for="formValidationConfirmPass">Import Entity</label>
