  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="row g-3" action="{{route('client_group.store')}}" method="POST" enctype="multipart/form-data">
          @csrf
         <div class="row  mt-2">

            <div class="col-md-4">
                <label class="form-label" for="formValidationName"><span class="mandatory">*</span>  Client Group </label>
                <input type="text" class="form-control" placeholder="Enter Client Group" name="client_group" />
                @if (count($errors) > 0)
...
<div class="row mt-4 mb-3">
                                       <div class="col-md-6">
                                          ...
                                          <textarea type="text" class="form-control" placeholder="Enter Responsibility 1" name="responsibility" /></textarea>
                                          @if (count($errors) > 0)
...
<div class="row mt-4 mb-3">
                                       <div class="col-md-6">
                                          <label class="form-label" for="formValidationName"><span class="mandatory"></span> Responsibility</label>
                                          <textarea type="text" class="form-control" placeholder="Enter Responsibility 2" name="responsibility2" /></textarea>
                                       </div>
