...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item active">Compliance by Client Groups</li>
      </ol>
    </nav>

{{--<form action="{{url('expertrepoergroup')}}" method="get">--}}
{{--<div class="row">
   <div class="col-md-2">
                        ...
                        {{--<div class="col-md-3">
                           <div class="input-group input-group-merge">
                              ...
                              {{--<button style=""><span class="tf-icons bx bx-search"> </span></button>&nbsp;
                              <input type="text" class="form-control" placeholder="Search User by Group Name" aria-label="Search..." aria-describedby="basic-addon-search31"  value="{{ request()->query('search') }}" name="entity_type" />--}}
                            </button>
                     ...
                     <form action="{{url('searchclientgroup')}}" method="get">
<div class="row">
...
<div class="col-md-2">
 ...
 <button type="search" class="btn btn-primary">search</button>
  ...
  <div class="col-md-7" style="text-align: end;"><a href="{{url('expertrepoergroup')}}">
                           <button type="button" class="btn btn-primary">
                           <span class="tf-icons bx bx-plus"></span>&nbsp; Download Reports
                           </button></a>
                        </div>
...
<div class="card p-3 mt-3">
   ...
   <table class="dt-column-search table table-bordered">
        ...
        <tfoot>
           ...
           <td>{{ empty($item->client_entity_name)? "-" : $item->client_entity_name }}</td>
