...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item active">Late Filed Compliances before Comments</li>
      </ol>
    </nav>
<form action="{{url('searchoverdue2')}}" method="get">
<div class="row">
...
<div class="col-md-2">
 ...
 <button type="search" class="btn btn-primary">search</button>
  ...
  <div class="col-md-7" style="text-align: end;">
                          <a href="{{url('exportoverdue2')}}"> <button type="button" class="btn btn-primary">
                           <span class="tf-icons bx bx-plus"></span>&nbsp; Download Reports
                           </button></a>
                        </div>
</div>
