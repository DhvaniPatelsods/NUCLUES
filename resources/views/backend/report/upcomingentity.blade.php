...
<h4 class="fw-bold ">
   UPCOMING COMPLIANCES BY ENTITY NAME  
</h4>
...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb breadcrumb-style1">
        ...
        <li class="breadcrumb-item active">Upcoming Compliances by Entity Name</li>
      </ol>
    </nav>
<form action="{{url('searchupcomingentity')}}" method="get">
<div class="row">
...
<div class="col-md-2">
 ...
 <button type="search" class="btn btn-primary">search</button>
  ...
  <div class="col-md-7" style="text-align: end;">
                          <a href="{{url('exportupcomingentity')}}"> <button type="button" class="btn btn-primary">
                           <span class="tf-icons bx bx-plus"></span>&nbsp; Download Reports
                           </button></a>
                        </div>
</div>
...
<div class="card p-3 mt-3">
 ...
 <table class="dt-column-search table table-bordered">
        ...
        <tfoot>
           @foreach($upcomingentity as $item)
           <tr>
            <td>
